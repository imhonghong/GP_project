...
def repeat():
  ...
  def DP(data):
      ...
      train_data = data_1.sample(frac=1/100);
  ...
  data=pd.read_csv('/content/drive/MyDrive/Colab Notebooks/project/大學部專題資料集/資安資料集/Phishing Websites Data Set/Source.txt',header=None)
  # data=pd.read_csv('/content/drive/MyDrive/Colab Notebooks/project/大學部專題資料集/資安資料集/Phishing_Legitimate_full/Phishing_Legitimate_full.csv',header=None)
  # data=pd.read_csv('/content/drive/MyDrive/Colab Notebooks/project/大學部專題資料集/資安資料集/Website Phishing Data Set/csv_result-PhishingData.csv',header=None)
  # data=pd.read_csv('/content/drive/MyDrive/Colab Notebooks/project/大學部專題資料集/資安資料集/Obfuscated-MalMem2022.csv',header=None,low_memory=False)
